...
export class HomePage {
   ...
   viewProfiePic()
    ...
    share()
    {
        ...
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.tirupatistructural.app";
        
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on  Tirupati Structural Ltd., app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Karigar Reffral", image, app_url)
        .then(resp=>{
            console.log(resp);
